...
void sendDataPos() {
  String msg = "ip" + ',' + marker.getPosX() + ',' + marker.getPosY() + ',' + motor1.pos + ',' + motor2.pos;
  wsc.sendMessage(msg);
}

void sendDataVec() {
  String msg = "iv" + ',' + marker.getPosX() + ',' + marker.getPosY() + ',' + marker.lastPosX() + ',' + marker.lastPosY() + ',' + motor1.pos + ',' + motor2.pos;
  wsc.sendMessage(msg);
}
